...
GLOVE_MODEL = "../chatbot_train/very_large_data/glove.6B.100d.txt"
...
class GunthercoxWordGloveChatBot(object):
    ...
    def __init__(self):
        ...
        self.target_word2idx = np.load('../chatbot_train/models/gunthercox/word-glove-target-word2idx.npy').item()
        self.target_idx2word = np.load('../chatbot_train/models/gunthercox/word-glove-target-idx2word.npy').item()
        context = np.load('../chatbot_train/models/gunthercox/word-glove-context.npy').item()
        ...
        # model_json = open('../chatbot_train/models/gunthercox/word-glove-architecture.json', 'r').read()
        # self.model = model_from_json(model_json)
        self.model.load_weights('../chatbot_train/models/gunthercox/word-glove-weights.h5')
